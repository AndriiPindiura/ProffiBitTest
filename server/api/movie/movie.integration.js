...
describe('Movie API:', function() {
  ...
  describe('PUT /api/movies/:id', function() {
    ...
    it('should respond with the original movie', function() {
      expect(updatedMovie.name).to.equal('New Movie');
      expect(updatedMovie.info).to.equal('This is the brand new movie!!!');
    });
    ...
    it('should respond with the updated movie on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          expect(movie.name).to.equal('Updated Movie');
          expect(movie.info).to.equal('This is the updated movie!!!');
  ...
  describe('PATCH /api/movies/:id', function() {
    ...
    it('should respond with the patched movie', function() {
      expect(patchedMovie.name).to.equal('Patched Movie');
      expect(patchedMovie.info).to.equal('This is the patched movie!!!');
    });
  });
